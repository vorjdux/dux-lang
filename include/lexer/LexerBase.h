...
#ifndef duxLexerBASE_H_INCLUDED
#define duxLexerBASE_H_INCLUDED
...
public:
    ...
    LexerBase &operator=(LexerBase const &rhs)    = delete;
...
protected:
    LexerBase(std::istream &in, std::ostream &out);
    LexerBase(std::string const &infilename, std::string const &outfilename);
    ~LexerBase();
...
inline LexerBase::StartCondition__ constexpr LexerBase::SC(int sc)
{
    return as<StartCondition__>(sc);
}

inline int constexpr LexerBase::SC(StartCondition__ sc)
{
    return as<int>(sc);
}
...
inline LexerBase::StartCondition__ LexerBase::startCondition() const
{
...
inline void LexerBase::begin(StartCondition__ startCondition)
{
    // $insert debug
    if (s_debug__)
...
inline size_t LexerBase::state__() const
{
    return d_state;
}

inline size_t LexerBase::get__()
{
    return (this->*d_get)();
}
...
inline bool LexerBase::return__()
{
    return d_return;
}

inline void LexerBase::noReturn__()
{
    d_return = false;
}
