...
DUX_VERSION=0.1.0 curl -sSf https://raw.githubusercontent.com/vorjdux/dux-lang/main/install.sh | sh
...
# RHEL / CentOS (rpm)
sudo rpm -i dux-lang-0.1.0-1.x86_64.rpm
```
...
| Platform | Archive |
|----------|---------|
| Linux x86_64 | `dux-0.1.0-linux-x86_64.tar.gz` |
| Linux ARM64 (aarch64) | `dux-0.1.0-linux-aarch64.tar.gz` |
| macOS Apple Silicon (ARM64) | `dux-0.1.0-macos-aarch64.tar.gz` |
| macOS Intel (x86_64) | `dux-0.1.0-macos-x86_64.tar.gz` |

```bash
# Example: Linux x86_64
wget https://github.com/vorjdux/dux-lang/releases/download/v0.1.0/dux-0.1.0-linux-x86_64.tar.gz

# Verify checksum
wget https://github.com/vorjdux/dux-lang/releases/download/v0.1.0/SHA256SUMS
